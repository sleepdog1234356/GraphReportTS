"""Precompute deterministic GTR battery features.
...
from anchoredgtr.data_mit import CellRecord, _summary_to_frame
...
def _load_mit_records_compatible(
    ...
    *,
    ...
    GTR avoids changing the established v1 data path.
    """
...
def precompute(
    ...
    *,
    ...
    if name == "calce":
        raise ValueError("CALCE is excluded from the approved GTR design")
    if name == "mit":
