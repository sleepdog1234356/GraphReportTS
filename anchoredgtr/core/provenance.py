...
PROVENANCE_SCHEMA = "gtr-provenance-v1"
DEFAULT_EXCLUDES = {
    ".git",
    ".migration-transfer",
    "__pycache__",
...
def write_provenance(
    ...
    *,
    ...
    payload = {
        "schema": PROVENANCE_SCHEMA,
        "project": source_snapshot(project, "AnchoredGTR"),
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Record AnchoredGTR source and hardware provenance")
    parser.add_argument("--project_root", default=".")
    parser.add_argument("--external_root", default="external")
    parser.add_argument("--output", default="runs/anchoredgtr/provenance.json")
