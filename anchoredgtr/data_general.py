...
def _find_csv(data_root: Path, dataset_name: str) -> Path:
    organized_raw = {
        "ETTm1": data_root / "raw" / "ETT-small" / "ETTm1.csv",
        "ETTm2": data_root / "raw" / "ETT-small" / "ETTm2.csv",
        "ETTh1": data_root / "raw" / "ETT-small" / "ETTh1.csv",
        "ETTh2": data_root / "raw" / "ETT-small" / "ETTh2.csv",
        "ECL": data_root / "raw" / "electricity" / "electricity.csv",
        "Weather": data_root / "raw" / "weather" / "weather.csv",
    }
    canonical_raw = {
        "ETTm1": data_root / "raw" / "general" / "ETT-small" / "ETTm1.csv",
        "ETTm2": data_root / "raw" / "general" / "ETT-small" / "ETTm2.csv",
        "ETTh1": data_root / "raw" / "general" / "ETT-small" / "ETTh1.csv",
        "ETTh2": data_root / "raw" / "general" / "ETT-small" / "ETTh2.csv",
        "ECL": data_root / "raw" / "general" / "electricity" / "electricity.csv",
        "Weather": data_root / "raw" / "general" / "weather" / "weather.csv",
    }
    candidates = [
        data_root / "processed" / dataset_name / f"{dataset_name}.csv",
        organized_raw.get(dataset_name),
        data_root / "processed" / "general" / dataset_name / f"{dataset_name}.csv",
        data_root / "raw" / "general" / dataset_name / f"{dataset_name}.csv",
        canonical_raw.get(dataset_name),
...
class GeneralForecastGraphDataset(Dataset):
    ...
    def __init__(
        ...
        self.prompt_len = self.input_len if prompt_len is None else int(prompt_len)
