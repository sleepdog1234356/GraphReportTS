...
from bstalignment.v2.general_data import GeneralForecastV2Dataset
from bstalignment.v2.prompts import (
...
class GeneralPromptV2Tests(unittest.TestCase):
    @staticmethod
    ...
    def test_training_threshold_fit_tracks_the_v2_metric_schema(self) -> None:
    ...
    def test_dataset_item_reuses_prompt_result_for_text_and_metadata(self) -> None:
        dataset = GeneralForecastV2Dataset.__new__(GeneralForecastV2Dataset)
        dataset.samples = [36]
