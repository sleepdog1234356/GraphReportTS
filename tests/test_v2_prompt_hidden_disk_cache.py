...
from bstalignment.v2.prompt_hidden_cache import (
...
from bstalignment.v2.train_general import _dataset_prompts, parse_args
...
class PersistentPromptHiddenCacheTests(unittest.TestCase):
    ...
    def base_identity() -> dict[str, object]:
        return {
            "schema": "graph-report-ts-v2-general-prompt-hidden-v1",
            "model": {"path": "fake-distilbert", "sha256": "model-sha"},
            "text_max_length": 12,
            "prompt_schema": {"schema": "general-prompt-v2", "sha256": "prompt-schema-sha"},
